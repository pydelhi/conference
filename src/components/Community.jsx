...
const Community = () => {
  return (
    <div id='community' className="container mx-auto pt-12 mx-auto p-4 xl:pt-20">
      <h1 className="lg:text-4xl sm:text-3xl text-2xl font-Montserrat font-extrabold text-center text-[#212A5C] mb-4">Community Partnership</h1>
      <div className="">
      ...
      <div className='flex flex-row justify-center'>
        <div className="mt-6 grid lg:grid-cols-4 grid-cols-2 gap-4  max-w-8xl px-8 m-auto">
          ...
          <div className="p-2   bg-gray-200 md:bg-white my-2">
            <div className="sm:w-56 h-full flex relative justify-center items-center cursor-pointer hover:bg-gray-200 border-2 ">              <a
