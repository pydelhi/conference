    ...
    <div id="code" className="container mx-auto px-4 py-8">
      ...
      <div className="">
        <div className="code-of-conduct bg-[#dfe4ef] border border-gray-300 p-6 mb-6">
          <h2 className="text-2xl font-bold mb-4 bg-[#dfe4ef]  text-[#212A5C]">Code of Conduct</h2>
          <div className="flex flex-row justify-between bg-[#dfe4ef]">
            <div className="bg-[#dfe4ef] w-[90%]">
        ...
        <p className="font-medium text-lg">If you have any questions or need assistance, please contact the organizers.</p>
      </div>
    </div>
  )
}
