            ...
            <section className=" ">
                <div className="flex">
                    <div className="mr-auto pt-6  sm:pt-12 sm:mx-[3.2REM] mx-4 place-self-center lg:col-span-7">
                        <h1 className="text-2xl  font-extrabold tracking-tight leading-none sm:text-5xl md:text-6xl ">PY<spand>DELHI</spand> CONFERENCE</h1>
                        <p className="text-sm sm:text-lg tracking-tight sm:tracking-wider">CONFERENCE ON PYTHON PROGRAMMING LANGUAGE</p>
                    </div>
